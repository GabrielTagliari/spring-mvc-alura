...
<html lang="pt-BR">
   <head>
      ...
      <link rel="icon"
         ...
         type="image/png" />
      <link href="https://plus.google.com/108540024862647200608"
         rel="publisher">
   ...
   <body class="produto">
      <header role="banner" class="cabecalhoPrincipal container">
         <h1 class="cabecalhoPrincipal-titulo">
            <a tabindex="1" href="/" class="cabecalhoPrincipal-linkTitulo">
               <svg
                  ...
                  <rect class="logo-backgroundSimbolo" x="-181" y="211.4" class="st0"
                     width="65" height="55" />
                  <g class="logo-simbolo">
                     <path transform="translate(-0.1, 0)" class="logo-simboloParteInterna"
         ...
         <div id="navegacaoCabecalho" class="cabecalhoPrincipal-navegacao">
            <div class="cabecalhoPrincipal-categoriasEBusca" role="presentation">
               <nav role="navigation" aria-label="Categorias de livros"
                  ...
                  <li class="colecoesDaCDC-colecaoItem"><a
                     href="/collections/livros-de-java"
                  ...
                  <li class="colecoesDaCDC-colecaoItem"><a
                     href="/collections/livros-de-front-e-design"
                     class="colecoesDaCDC-colecaoLink"> Front e Design </a></li>
                  <li class="colecoesDaCDC-colecaoItem"><a
                     href="/collections/livros-de-games"
                     class="colecoesDaCDC-colecaoLink"> Games </a></li>
                  <li class="colecoesDaCDC-colecaoItem"><a
                     href="/collections/livros-de-mobile"
                     class="colecoesDaCDC-colecaoLink"> Mobile </a></li>
                  <li class="colecoesDaCDC-colecaoItem"><a
                     href="/collections/livros-de-startups"
                     class="colecoesDaCDC-colecaoLink"> Startups </a></li>
               </nav>
               <form role="search" aria-labelledby="rotuloBuscaPrincipal"
                  ...
                  <label id="rotuloBuscaPrincipal" class="buscaPrincipal-label"
                     for="campoBuscaPrincipal"> Busque por autor, tÃ­tulo,
                  conteÃºdo... </label> <input type="hidden" name="type" value="product">
            ...
            <a tabindex="3" href="/carrinho" title="Ir para sacola de compras"
               class="sacola cabecalhoPrincipal-itemNavegacao">
               <svg
         ...
         <article id="${produto.id}" itemscope>
               ...
               <div class="cabecalhoProdutoLivro-tituloEAutor">
                  <h1 itemprop="name" class="cabecalhoProdutoLivro-titulo">
                     <span class="cabecalhoProdutoLivro-titulo-principal"
                        role="presentation"> ${produto.titulo} </span> 
            ...
            <form action="/carrinho/add" method="POST" class="adicionarAoCarrinho">
               <ul class="adicionarAoCarrinho-listaOfertas">
                  ...
                  <li class="adicionarAoCarrinho-oferta" itemprop="offers" itemscope>
                     <label
                        class="adicionarAoCarrinho-infosDaOferta"
                        for="product-variant-970168053">
                        <span
                           ...
                           class="adicionarAoCarrinho-tipoDaOferta-nome"> ${preco.tipo} </span>
                        </span>
                     ...
                     <button class="adicionarAoCarrinho-botaoComprar" type="submit"
                        name="tipo" value="${preco.tipo}" title="Compre agora '${produto.titulo}'!">
                     Comprar</button>
                  </li>
                  </c:forEach>
               </ul>
            ...
            <section class="infosAdicionaisDoLivro infoSection">
               ...
               <dl class="infosAdicionaisDoLivro-info">
                  ...
                  <dt class="infosAdicionaisDoLivro-info-titulo">Data de publicação:</dt>
                  <dd class="infosAdicionaisDoLivro-info-valor" itemprop="isbn">${produto.dataLancamento}</dd>
               </dl>
            </section>
